...
define(['creatartis-base', 'sermat', 'ludorum', 'ludorum-game-strategic-tictactoe'],
function (base, Sermat, ludorum, ludorum_game_strategic_tictactoe) {
	...
	describe("games.StrategicTicTacToe", function () {
		var game = new ludorum_game_strategic_tictactoe.StrategicTicTacToe(),
